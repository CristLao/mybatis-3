...
public class MapperMethod {
    ...
    public Object execute(SqlSession sqlSession, Object[] args) {
        ...
        if (result == null && method.getReturnType().isPrimitive() && !method.returnsVoid()) {
            throw new BindingException("Mapper method '" + command
                    .getName() + " attempted to return null from a method with a primitive return type (" + method
                    .getReturnType() + ").");
        }
        return result;
    }
    ...
    private void executeWithResultHandler(SqlSession sqlSession, Object[] args) {
        ...
        if (!StatementType.CALLABLE.equals(ms.getStatementType()) && void.class
            ...
            throw new BindingException("method " + command
                    .getName() + " needs either a @ResultMap annotation, a @ResultType annotation," + " or a " +
